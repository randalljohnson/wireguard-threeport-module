module github.com/randalljohnson/wireguard-threeport-module
...
require (
	...
	github.com/nukleros/aws-builder v0.4.9 // indirect
	...
	github.com/pulumi/pulumi-oci/sdk/v2 v2.32.0 // indirect
