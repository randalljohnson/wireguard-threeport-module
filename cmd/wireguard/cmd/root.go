...
// rootCmd represents the wireguard command which is the root command for
// the Wireguard plugin.
var rootCmd = &cobra.Command{
	Long:  "Manage the Wireguard Threeport module",
	Short: "Manage the Wireguard Threeport module",
	Use:   "wireguard",
}
