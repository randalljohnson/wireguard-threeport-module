...
import (
	...
	util "github.com/randalljohnson/wireguard-threeport-module/cmd/rest-api/util"
	version "github.com/randalljohnson/wireguard-threeport-module/internal/version"
	database "github.com/randalljohnson/wireguard-threeport-module/pkg/api-server/v0/database"
	handlers_v0 "github.com/randalljohnson/wireguard-threeport-module/pkg/api-server/v0/handlers"
	routes_v0 "github.com/randalljohnson/wireguard-threeport-module/pkg/api-server/v0/routes"
	versions_v0 "github.com/randalljohnson/wireguard-threeport-module/pkg/api-server/v0/versions"
...
// @title Wireguard Threeport API
// @version v0.0.1-dev
// @description API server for the Threeport Wireguard module.
// @contact.name Randall Johnson
// @contact.email rj9317@gmail.com
// @BasePath /randalljohnson.us
func main() {
	// flags
	var envFile string
	...
	e.Logger.Infof("Threeport module REST API for API namespace randalljohnson.us: %s", version.GetVersion())
